...
<head>
    <title>Справка</title>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="/RS_ContextHelp/RS_MiniForms/css/showArticleForm.css">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on('click', '#RS_TableOfContents li a', function (event) {
                ...
                $('#RS_DataContainer').load("/RS_ContextHelp/RS_MiniForms/showArticleForm.php #RS_Search,#RS_RefContainer", {
                    'page_id': aid
                });
            });
...
<div id="RS_DataContainer">
    ...
    <div id="RS_RefContainer" class="RS_Help class1 class2 RS_D1">
        ...
        <div id="RS_Content">
            ...
            {
                $article = ReferenceSystem\ReferenceSystem::GetArticleByDBId(intval($_POST['page_id']));
