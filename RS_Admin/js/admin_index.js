$(document).ready(function () {
    ...
    $('#AddDataForm input[type=submit]').click(function (event) {
        ...
        $.post('/RS_API/api.php', formData, function () {
            location.reload();
        });
    });
    ...
    $('#EditDataForm input[type=submit]').click(function (event) {
        ...
        $.post('/RS_API/api.php', formData, function (result) {
            location.reload();
        });
    });
    ...
    ep.change(function () {
        ...
        $.post('/RS_API/api.php', {'mode': 'article', 'action':'get', 'pathOrId': ep.val()}, function (result) {
        ...
        $.post('/RS_API/api.php', {'mode': 'html_children', 'action': 'get', 'pathOrId': ep.val()}, function (result) {
